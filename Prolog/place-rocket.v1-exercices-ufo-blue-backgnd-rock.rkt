...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname place-rocket.v1-exercices-ufo-blue-backgnd-rock) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
(define SCN_WITH_ROCK (place-image (rectangle 100 10 "solid" "black")
                                   CENTER (- HEIGHT 5)
                                   MTSCN))
